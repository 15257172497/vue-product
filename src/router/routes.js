...
const User = () =>
    import ( /* webpackChunkName: "group-foo" */ 'views/user')
const Shop = () =>
    import ( /* webpackChunkName: "group-foo" */ 'views/shop')
const Food = () =>
    import ( /* webpackChunkName: "group-foo" */ 'views/food')
const ShopAdd = () =>
    import ( /* webpackChunkName: "group-foo" */ 'views/shop_add')
const FoodAdd = () =>
    import ( /* webpackChunkName: "group-foo" */ 'views/food_add')
const Set = () =>
    import ( /* webpackChunkName: "group-foo" */ 'views/set')
const Explain = () =>
    import ( /* webpackChunkName: "group-foo" */ 'views/explain')
const Login = () =>
...
const ShopModify = () =>
    import ( /* webpackChunkName: "group-foo" */ 'views/shop_modify')
export default [{
        path: '/',
        redirect: '/home'
    },
